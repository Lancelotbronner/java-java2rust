...
pub struct RustUnit {
	jar: java2rust::rust_jar::RustJar,
	path: /* Java */ java::nio::file::Path /**/,
	pkg: java2rust::rust_package::RustPackage,
	java: com::github::javaparser::parse_result::ParseResult,
}

impl RustUnit {
	pub fn new(jar: &java2rust::rust_jar::RustJar, pkg: &java2rust::rust_package::RustPackage, path: &/* Java */ java::nio::file::Path /**/) /* thrown(java.io.IOException) */ -> java2rust::rust_unit::RustUnit {
		let parser: JavaParser = JavaParser::new(&StaticJavaParser::get_parser_configuration());
		this(jar, path, pkg, &parser.parse(path)?);
	}

	pub fn new(jar: &java2rust::rust_jar::RustJar, path: &/* Java */ java::nio::file::Path /**/, pkg: &java2rust::rust_package::RustPackage, java: &com::github::javaparser::parse_result::ParseResult) -> java2rust::rust_unit::RustUnit {
		self.jar = jar;
		self.path = path;
		self.pkg = pkg;
		self.java = java;
