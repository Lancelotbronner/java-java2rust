...
impl RustImport {
	pub fn new(java: &com::github::javaparser::ast::import_declaration::ImportDeclaration, mod: &java2rust::rust_package::RustPackage) -> java2rust::rust_import::RustImport {
		self.java = java;
		self.module = mod;
	...
	pub fn to_string(&self, crate: &java2rust::rust_jar::RustJar) -> /* Java */ java::lang::String /**/ {
		let root: String;
		if self.crate == null {
