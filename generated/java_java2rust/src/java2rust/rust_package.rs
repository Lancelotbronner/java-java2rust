...
pub struct RustPackage {
	...
	crate: java2rust::rust_jar::RustJar,
...
impl RustPackage {
	fn new(name: &/* Java */ java::lang::String /**/, module: &java2rust::rust_package::RustPackage, visibility: &/* Java */ java2rust::RustVisibility /**/, crate: &java2rust::rust_jar::RustJar) -> java2rust::rust_package::RustPackage {
	...
	fn module_if_not_top(&self) -> java2rust::rust_package::RustPackage {
		if  == null {
			return null;
		}
	...
	pub fn locate(&self, path: &/* Java */ java::lang::String /**/) -> java2rust::rust_package::RustPackage {
	...
	pub fn parent(&self) -> java2rust::rust_package::RustPackage {
		return ;
	}
	...
	pub fn submodule(&self, name: &/* Java */ java::lang::String /**/, visibility: &/* Java */ java2rust::RustVisibility /**/) -> java2rust::rust_package::RustPackage {
	...
	pub fn mod(&self, name: &/* Java */ java::lang::String /**/, visibility: &/* Java */ java2rust::RustVisibility /**/) -> java2rust::rust_package::RustPackage {
		let mod: RustPackage = RustPackage::new(&Java2Rust::camel_case_to_snake_case(name), self, visibility, self.crate);
		self.items.add(mod);
		return mod;
	}

	pub fn clazz(&self, name: &/* Java */ java::lang::String /**/, decl: &com::github::javaparser::resolution::declarations::resolved_class_declaration::ResolvedClassDeclaration, visibility: &/* Java */ java2rust::RustVisibility /**/) -> java2rust::rust_class::RustClass {
	...
	pub fn record(&self, name: &/* Java */ java::lang::String /**/, decl: &com::github::javaparser::resolution::declarations::resolved_record_declaration::ResolvedRecordDeclaration, visibility: &/* Java */ java2rust::RustVisibility /**/) -> java2rust::rust_record::RustRecord {
		//TODO: Ensure struct name is PascalCase
	...
	pub fn trait(&self, name: &/* Java */ java::lang::String /**/, decl: &com::github::javaparser::resolution::declarations::resolved_interface_declaration::ResolvedInterfaceDeclaration, visibility: &/* Java */ java2rust::RustVisibility /**/) -> java2rust::rust_interface::RustInterface {
	...
	pub fn enumeration(&self, java: &com::github::javaparser::ast::body::enum_declaration::EnumDeclaration) -> java2rust::rust_enum::RustEnum {
		//TODO: Ensure trait name is PascalCase
	...
	pub fn use(&self, java: &com::github::javaparser::ast::import_declaration::ImportDeclaration) -> java2rust::rust_import::RustImport {
