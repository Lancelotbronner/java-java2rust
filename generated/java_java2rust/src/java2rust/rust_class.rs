...
impl RustClass {
	fn new(name: &/* Java */ java::lang::String /**/, module: &java2rust::rust_package::RustPackage, decl: &com::github::javaparser::resolution::declarations::resolved_class_declaration::ResolvedClassDeclaration, visibility: &/* Java */ java2rust::RustVisibility /**/) -> java2rust::rust_class::RustClass {
