...
pub struct RustItem {
	...
	module: java2rust::rust_package::RustPackage,
...
impl RustItem {
	fn new(name: &/* Java */ java::lang::String /**/, module: &java2rust::rust_package::RustPackage, visibility: &/* Java */ java2rust::RustVisibility /**/) -> java2rust::rust_item::RustItem {
		self.name = name;
		self.module = module;
	...
	pub fn static_field(&self, field: &com::github::javaparser::ast::body::field_declaration::FieldDeclaration, declarator: &com::github::javaparser::ast::body::variable_declarator::VariableDeclarator) -> java2rust::rust_static::RustStatic {
		let tmp: RustStatic = RustStatic::new(self, field, declarator);
		self.statics.add(tmp);
		return tmp;
	}

	pub fn method(&self, java: &com::github::javaparser::ast::body::method_declaration::MethodDeclaration) -> java2rust::rust_method::RustMethod {
		let rust: RustMethod = RustMethod::new(self, java, &java.resolve());
		self.methods.add(rust);
		return rust;
	}

	pub fn constructor(&self, java: &com::github::javaparser::ast::body::constructor_declaration::ConstructorDeclaration) -> java2rust::rust_constructor::RustConstructor {
		let rust: RustConstructor = RustConstructor::new(self, java, &java.resolve());
		self.methods.add(rust);
		return rust;
	}

	pub fn initializer(&self, java: &com::github::javaparser::ast::body::initializer_declaration::InitializerDeclaration) -> java2rust::rust_initializer::RustInitializer {
