...
pub struct RustJar {
	...
	lib: java2rust::rust_package::RustPackage,
	main: java2rust::rust_package::RustPackage,
}

impl RustJar {
	pub fn new(id: &/* Java */ java::lang::String /**/, name: &/* Java */ java::lang::String /**/, path: &/* Java */ java::nio::file::Path /**/) -> java2rust::rust_jar::RustJar {
		self.id = id;
		self.name = Java2Rust::camel_case_to_snake_case(name).replace("-", "_");
		self.path = path;
		self.lib = RustPackage::new(self.name, null, RustVisibility::java2rust::rust_visibility::RustVisibility::INFERRED, self);
		self.main = RustPackage::new(self.name, null, RustVisibility::java2rust::rust_visibility::RustVisibility::INFERRED, self);
	}

	pub fn sources(&self, id: &/* Java */ java::lang::String /**/, name: &/* Java */ java::lang::String /**/, jar: &com::github::javaparser::utils::source_zip::SourceZip) /* thrown(java.io.IOException | java.lang.AssertionError) */ -> java2rust::rust_jar::RustJar {
		...
		jar.parse(|(relative_zip_entry_path, result)|{
			...
			for trunk in relative_zip_entry_path {
				pkg = pkg.submodule(&FilenameUtils.removeExtension(&trunk.toFile().getName()), RustVisibility::java2rust::rust_visibility::RustVisibility::PUB);
			}
	...
	pub fn add(&self, path: &/* Java */ java::nio::file::Path /**/, pkg: &java2rust::rust_package::RustPackage) /* thrown(java.io.IOException) */ {
		self.units.add(RustUnit::new(self, pkg, path));
	}

	pub fn add_source_code(&self, path: &/* Java */ java::nio::file::Path /**/, pkg: &java2rust::rust_package::RustPackage, code: &/* Java */ java::lang::String /**/) /* thrown(java.lang.AssertionError) */ {
	...
	pub fn add_script(&self, path: &/* Java */ java::nio::file::Path /**/, pkg: &java2rust::rust_package::RustPackage, code: &/* Java */ java::lang::String /**/) /* thrown(java.lang.AssertionError) */ {
		let parser: JavaParser = JavaParser::new(&StaticJavaParser::get_parser_configuration());
		self.units.add(RustUnit::new(self, path, pkg, &parser.parse(code)?));
	}
