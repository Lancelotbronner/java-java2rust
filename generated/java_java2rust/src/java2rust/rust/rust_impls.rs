...
pub struct RustImpls {
	...
	params: java2rust::rust::rust_ty_params::RustTyParams,
	traits: /* Java */ java::util::List /**/ = ArrayList<>::new(),
	problems: /* Java */ java::util::List /**/ = ArrayList<>::new(),
}

impl RustImpls {
	pub fn new(item: &java2rust::rust::rust_item::RustItem, params: &java2rust::rust::rust_ty_params::RustTyParams) -> java2rust::rust::rust_impls::RustImpls {
		self.item = item;
		self.params = params;
	}
