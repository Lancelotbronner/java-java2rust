...
impl RustConstructor {
	pub fn new(item: &java2rust::rust::rust_item::RustItem, java: &com::github::javaparser::ast::body::constructor_declaration::ConstructorDeclaration, resolved: &com::github::javaparser::resolution::declarations::resolved_constructor_declaration::ResolvedConstructorDeclaration) -> java2rust::rust::rust_constructor::RustConstructor {
		self.item = item;
		self.java = java;
...
impl java2rust::rust::i_rust_function::IRustFunction for RustConstructor {}