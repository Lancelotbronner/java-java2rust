...
pub struct RustStatic {
	parent: java2rust::rust::rust_item::RustItem,
...
impl RustStatic {
	pub fn new(parent: &java2rust::rust::rust_item::RustItem, field: &com::github::javaparser::ast::body::field_declaration::FieldDeclaration, declarator: &com::github::javaparser::ast::body::variable_declarator::VariableDeclarator) /* thrown(java.lang.UnsupportedOperationException) */ -> java2rust::rust::rust_static::RustStatic {
		self.parent = parent;
	...
	pub fn analyze(&mut self, transpiler: &java2rust::java_transpiler::JavaTranspiler, item: &java2rust::rust::rust_item::RustItem) /* thrown(java.lang.UnsupportedOperationException) */ {
