...
pub struct RustMethod {
	...
	params: java2rust::rust::rust_params::RustParams,
	thrown: /* Java */ java::util::Set /**/ = HashSet<>::new(),
	calls: java2rust::rust::rust_calls::RustCalls = RustCalls::new(),
...
impl RustMethod {
	pub fn new(item: &java2rust::rust::rust_item::RustItem, java: &com::github::javaparser::ast::body::method_declaration::MethodDeclaration, resolved: &com::github::javaparser::resolution::declarations::resolved_method_declaration::ResolvedMethodDeclaration) -> java2rust::rust::rust_method::RustMethod {
		self.item = item;
		self.java = java;
		...
		self.params = RustParams::new(RustSelf::java2rust::rust::rust_self::RustSelf::REF, &java.get_parameters());
	}

	pub fn analyze(&mut self, transpiler: &java2rust::java_transpiler::JavaTranspiler, item: &java2rust::rust::rust_item::RustItem) {
	...
	pub fn item(&self) -> java2rust::rust::rust_item::RustItem {
		return self.item;
	}

	pub fn params(&self) -> java2rust::rust::rust_params::RustParams {
		return self.params;
	}

	pub fn calls(&self) -> java2rust::rust::rust_calls::RustCalls {
		return self.calls;
	}
...
impl java2rust::rust::i_rust_function::IRustFunction for RustMethod {}