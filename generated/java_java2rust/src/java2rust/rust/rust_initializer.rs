...
impl RustInitializer {
	pub fn new(item: &java2rust::rust::rust_item::RustItem, java: &com::github::javaparser::ast::body::initializer_declaration::InitializerDeclaration) -> java2rust::rust::rust_initializer::RustInitializer {
		self.item = item;
		self.java = java;
	...
	pub fn params(&self) -> java2rust::rust::rust_params::RustParams {
		return RustParams::java2rust::rust::rust_params::RustParams::EMPTY;
	}
	...
	pub fn analyze(&self, transpiler: &java2rust::java_transpiler::JavaTranspiler, item: &java2rust::rust::rust_item::RustItem) {
...
impl java2rust::rust::i_rust_function::IRustFunction for RustInitializer {}