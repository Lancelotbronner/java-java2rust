...
impl RustEnum {
	fn new(java: &com::github::javaparser::ast::body::enum_declaration::EnumDeclaration, module: &java2rust::rust::rust_package::RustPackage) -> java2rust::rust::rust_enum::RustEnum {
