...
impl RustField {
	fn new(name: &/* Java */ java::lang::String /**/, java_type: &com::github::javaparser::ast::type::type::Type, java_initializer: &com::github::javaparser::ast::expr::expression::Expression) -> java2rust::rust::rust_field::RustField {
