...
pub struct EqualsVisitor;

impl EqualsVisitor {
	static SINGLETON: com::github::javaparser::ast::visitor::equals_visitor::EqualsVisitor = EqualsVisitor::new();
	...
	fn new() -> com::github::javaparser::ast::visitor::equals_visitor::EqualsVisitor {
	// hide constructor
	}

	fn common_node_equality(&self, n: &com::github::javaparser::ast::node::Node, n2: &com::github::javaparser::ast::node::Node) -> bool {
		if !self.node_equals(&n.get_comment(), &n2.get_comment()) {
			return false;
		}
		return self.nodes_equals(&n.get_orphan_comments(), &n2.get_orphan_comments());
	}

	fn nodes_equals<T: com::github::javaparser::ast::node::Node>(&self, nodes1: &/* Java */ java::util::List /**/, nodes2: &/* Java */ java::util::List /**/) -> bool {
		if nodes1 == null {
			return nodes2 == null;
		}
		if nodes2 == null {
		...
		if nodes1.size() != nodes2.size() {
		...
		}
		 {
			...
			while i < nodes1.size() {
				{
					if !self.node_equals(&nodes1.get(i), &nodes2.get(i)) {
						return false;
					}
				}
				i += 1;
	...
	fn node_equals<T: com::github::javaparser::ast::node::Node>(&self, n: &T, n2: &T) -> bool {
		...
		if !self.common_node_equality(n, n2) {
			return false;
		}
	...
	pub fn visit(&self, n: &com::github::javaparser::ast::comments::line_comment::LineComment, arg: &com::github::javaparser::ast::visitor::visitable::Visitable) -> /* Java */ java::lang::Boolean /**/ {
		/* final */ let n2: LineComment = arg as LineComment;
	...
	pub fn visit(&self, n: &com::github::javaparser::ast::comments::block_comment::BlockComment, arg: &com::github::javaparser::ast::visitor::visitable::Visitable) -> /* Java */ java::lang::Boolean /**/ {
		/* final */ let n2: BlockComment = arg as BlockComment;
		if !self.obj_equals(&n.get_content(), &n2.get_content()) {
			return false;
		}
	...
	pub fn visit(&self, n: &com::github::javaparser::ast::comments::traditional_javadoc_comment::TraditionalJavadocComment, arg: &com::github::javaparser::ast::visitor::visitable::Visitable) -> /* Java */ java::lang::Boolean /**/ {
		/* final */ let n2: TraditionalJavadocComment = arg as TraditionalJavadocComment;
		if !self.obj_equals(&n.get_content(), &n2.get_content()) {
			return false;
		}
	...
	pub fn visit(&self, n: &com::github::javaparser::ast::expr::null_literal_expr::NullLiteralExpr, arg: &com::github::javaparser::ast::visitor::visitable::Visitable) -> /* Java */ java::lang::Boolean /**/ {
		/* final */ let n2: NullLiteralExpr = arg as NullLiteralExpr;
		if !self.node_equals(&n.get_comment(), &n2.get_comment()) {
			return false;
		}
	...
	pub fn visit(&self, n: &com::github::javaparser::ast::stmt::empty_stmt::EmptyStmt, arg: &com::github::javaparser::ast::visitor::visitable::Visitable) -> /* Java */ java::lang::Boolean /**/ {
		/* final */ let n2: EmptyStmt = arg as EmptyStmt;
		if !self.node_equals(&n.get_comment(), &n2.get_comment()) {
			return false;
		}
	...
	pub fn visit(&self, n: &com::github::javaparser::ast::stmt::unparsable_stmt::UnparsableStmt, arg: &com::github::javaparser::ast::visitor::visitable::Visitable) -> /* Java */ java::lang::Boolean /**/ {
		/* final */ let n2: UnparsableStmt = arg as UnparsableStmt;
		if !self.node_equals(&n.get_comment(), &n2.get_comment()) {
			return false;
		}
...
impl com::github::javaparser::ast::visitor::generic_visitor::GenericVisitor for EqualsVisitor {}