...
pub struct NoUnderscoresInIntegerLiteralsValidator;

impl NoUnderscoresInIntegerLiteralsValidator {
	pub fn visit(&self, n: &com::github::javaparser::ast::expr::integer_literal_expr::IntegerLiteralExpr, arg: &com::github::javaparser::ast::validator::problem_reporter::ProblemReporter) {
		com::github::javaparser::ast::validator::language_level_validations::chunks::no_underscores_in_integer_literals_validator::NoUnderscoresInIntegerLiteralsValidator::validate(n, arg);
		super.visit(n, arg);
	}
	...
	fn validate(&self, n: &com::github::javaparser::ast::expr::literal_string_value_expr::LiteralStringValueExpr, arg: &com::github::javaparser::ast::validator::problem_reporter::ProblemReporter) {
		if n.get_value().contains("_") {
			arg.report(n, "Underscores in literal values are not supported.");
		}
	}
}

impl com::github::javaparser::ast::visitor::void_visitor::VoidVisitor for NoUnderscoresInIntegerLiteralsValidator {}

impl com::github::javaparser::ast::validator::validator::Validator for NoUnderscoresInIntegerLiteralsValidator {}

impl com::github::javaparser::ast::validator::typed_validator::TypedValidator for NoUnderscoresInIntegerLiteralsValidator {}

impl /* Java */ java::util::function::BiConsumer /**/ for NoUnderscoresInIntegerLiteralsValidator {}