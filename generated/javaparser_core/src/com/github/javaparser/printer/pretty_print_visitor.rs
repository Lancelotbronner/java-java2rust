...
pub struct PrettyPrintVisitor {
	configuration: com::github::javaparser::printer::configuration::pretty_printer_configuration::PrettyPrinterConfiguration,
...
impl PrettyPrintVisitor {
	...
	pub fn new(pretty_printer_configuration: &com::github::javaparser::printer::configuration::pretty_printer_configuration::PrettyPrinterConfiguration) -> com::github::javaparser::printer::pretty_print_visitor::PrettyPrintVisitor {
		self.configuration = pretty_printer_configuration;
		self.printer = SourcePrinter::new(self.configuration);
	}

	pub fn set_configuration(&mut self, pretty_printer_configuration: &com::github::javaparser::printer::configuration::pretty_printer_configuration::PrettyPrinterConfiguration) {
		self.configuration = pretty_printer_configuration;
	}
	...
	fn print_arguments<T: com::github::javaparser::ast::expr::expression::Expression>(&self, args: &com::github::javaparser::ast::node_list::NodeList, arg: &/* Java */ java::lang::Void /**/) /* thrown(java.lang.IllegalStateException) */ {
		self.printer.print("(");
		if !com::github::javaparser::utils::utils::Utils::is_null_or_empty(args) {
			let column_align_parameters: bool = (args.size() > 1) && self.configuration.is_column_align_parameters();
	...
	pub fn visit(&self, n: &com::github::javaparser::ast::expr::simple_name::SimpleName, arg: &/* Java */ java::lang::Void /**/) {
		self.printer.print(&n.get_identifier());
	}
	...
	pub fn visit(&self, n: &com::github::javaparser::ast::comments::traditional_javadoc_comment::TraditionalJavadocComment, arg: &/* Java */ java::lang::Void /**/) /* thrown(java.lang.AssertionError | java.lang.RuntimeException) */ {
		self.print_orphan_comments_before_this_child_node(n)?;
		if self.configuration.is_print_comments() && self.configuration.is_print_javadoc() {
			self.printer.println(&n.get_header());
			/* final */ let comment_content: String = com::github::javaparser::utils::utils::Utils::normalize_eol_in_text_block(&n.get_content(), &self.configuration.get_end_of_line_character());
	...
	pub fn visit(&self, n: &com::github::javaparser::ast::expr::array_initializer_expr::ArrayInitializerExpr, arg: &/* Java */ java::lang::Void /**/) /* thrown(java.lang.AssertionError | java.lang.RuntimeException) */ {
		self.print_orphan_comments_before_this_child_node(n)?;
		self.print_comment(&n.get_comment(), arg);
		self.printer.print("{");
	...
	pub fn visit(&self, n: &com::github::javaparser::ast::expr::assign_expr::AssignExpr, arg: &/* Java */ java::lang::Void /**/) /* thrown(java.lang.AssertionError | java.lang.RuntimeException) */ {
		...
		if self.configuration.is_space_around_operators() {
			self.printer.print(" ");
		}
	...
	pub fn visit(&self, n: &com::github::javaparser::ast::expr::method_call_expr::MethodCallExpr, arg: &/* Java */ java::lang::Void /**/) /* thrown(java.lang.AssertionError | java.lang.RuntimeException) */ {
		...
		if self.configuration.is_column_align_first_method_chain() {
	...
	fn print_switch_node(&self, n: &com::github::javaparser::ast::node_types::switch_node::SwitchNode, arg: &/* Java */ java::lang::Void /**/) {
		...
		if n.get_entries() != null {
			self.indent_if(&self.configuration.is_indent_case_in_switch());
			for /* final */ e in n.get_entries() {
				e.accept(self, arg);
			}
			self.unindent_if(&self.configuration.is_indent_case_in_switch());
		}
		self.printer.print("}");
	}
	...
	pub fn visit(&self, n: &com::github::javaparser::ast::body::enum_declaration::EnumDeclaration, arg: &/* Java */ java::lang::Void /**/) /* thrown(java.lang.AssertionError | java.lang.IllegalStateException | java.lang.RuntimeException) */ {
		...
		if n.get_entries().is_non_empty() {
			...
			/* final */ let align_vertically: bool = n.get_entries().size() > self.configuration.get_max_enum_constants_to_align_horizontally() || n.get_entries().stream().anyMatch(|e|e.get_comment().isPresent());
			self.printer.println();
			 {
	...
	pub fn visit(&self, n: &com::github::javaparser::ast::comments::line_comment::LineComment, arg: &/* Java */ java::lang::Void /**/) {
		if self.configuration.is_ignore_comments() {
			return;
		}
			...
			while i < (lines.length - 1) {
				{
					...
					self.printer.print(&self.configuration.get_end_of_line_character());
				}
				i += 1;
			 }
		 }
	...
	pub fn visit(&self, n: &com::github::javaparser::ast::node_list::NodeList, arg: &/* Java */ java::lang::Void /**/) {
		if self.configuration.is_order_imports() && n.size() > 0 && n.get(0) instanceof ImportDeclaration {
			// noinspection unchecked
			let modifiable_list: NodeList<ImportDeclaration> = NodeList<>::new(n);
			modifiable_list.sort(&/* Java */ java::util::Comparator /**/::comparingInt(|(i: &ImportDeclaration)| if i.is_static() { 0 } else { 1 }).thenComparing(NodeWithName::getNameAsString));
			for node in modifiable_list {
	...
	fn print_orphan_comments_ending(&self, node: &com::github::javaparser::ast::node::Node) {
		...
		let everything: List<Node> = node.get_child_nodes().stream().filter(|n|n.has_range()).collect(&Collectors::toList());
		com::github::javaparser::utils::position_utils::PositionUtils::sort_by_begin_position(everything);
...
impl com::github::javaparser::ast::visitor::void_visitor::VoidVisitor for PrettyPrintVisitor {}