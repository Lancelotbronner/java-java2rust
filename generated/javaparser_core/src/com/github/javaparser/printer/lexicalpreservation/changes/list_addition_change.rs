...
pub struct ListAdditionChange {
	observable_property: com::github::javaparser::ast::observer::observable_property::ObservableProperty,
	index: i32,
	node_added: com::github::javaparser::ast::node::Node,
}

impl ListAdditionChange {
	pub fn new(observable_property: &com::github::javaparser::ast::observer::observable_property::ObservableProperty, index: i32, node_added: &com::github::javaparser::ast::node::Node) -> com::github::javaparser::printer::lexicalpreservation::changes::list_addition_change::ListAdditionChange {
	...
	pub fn get_value(&self, property: &com::github::javaparser::ast::observer::observable_property::ObservableProperty, node: &com::github::javaparser::ast::node::Node) /* thrown(java.lang.IllegalStateException) */ -> /* Java */ java::lang::Object /**/ {
		if property == self.observable_property {
			...
			new_node_list.add(self.index, self.node_added);
...
impl com::github::javaparser::printer::lexicalpreservation::changes::change::Change for ListAdditionChange {}