...
public class PartParser {
    ...
    static CompilationUnit tryParse(String javaString) throws ParseException {
        return StaticJavaParser.parse(new ByteArrayInputStream(javaString.getBytes()));
    }
}
